    ...
    render(analyzedCandles, symbolInfo, activePosition = null) {
        ...
        if (activePosition) {
            shapes.push({
                ...
                y0: activePosition.takeProfitPrice, y1: activePosition.takeProfitPrice,
                yref: "y",
                line: { color: "#00e676", dash: "dash", width: 2 }
            });
            shapes.push({
                type: "line",
                x0: times[0], x1: times[times.length - 1],
                y0: activePosition.stopLossPrice, y1: activePosition.stopLossPrice,
                yref: "y",
